...
<img src="/images/cover.png" class="absolute inset-0 w-full h-full object-cover" />

<div class="absolute top-5 left-5 text-4xl opacity-100">
Make The Time

</div>


<div class="absolute bottom-5 left-5 text-lg opacity-80">
...
<div class="absolute top-0 left-0 text-sm opacity-60 border-2 border-white rounded-full px-4 py-1">
Intro
...
<div class="text-xl leading-relaxed mt-6">
...
<img src="/images/1440-c3po.png" class="absolute inset-0 w-full h-full object-cover" />
...
<img src="/images/vicious-cycle.png" class="absolute inset-0 w-full h-full object-cover" />

<div class="absolute bottom-5 left-5 text-3xl opacity-100">
The Churn
...
graph LR
    A[New Opportunities] --> B[Temptation]
    B --> C[Overload]
    C --> D[Overwork]
    D --> A
...
<img src="/images/collection.png" class="absolute inset-0 w-full h-full object-cover" />

<div class="absolute bottom-05 left-05 text-2xl opacity-80">
...
<img src="/images/task-collection-setup-1.png" class="absolute bottom-4 left-1/2 -translate-x-1/2 max-h-48 rounded-lg shadow-lg" />
...
<img src="/images/task-collection-setup-2.png" class="absolute bottom-4 left-1/2 -translate-x-1/2 max-h-48 rounded-lg shadow-lg" />
...
<img src="/images/calendar.png" class="absolute inset-0 w-full h-full object-cover" />
...
<img src="/images/daily-focus-mit.png" class="absolute inset-0 w-full h-full object-cover" />

<div class="absolute bottom-05 left-05 text-2xl opacity-100">
...
<img src="/images/daily-focus-concentration.png" class="absolute inset-0 w-full h-full object-cover" />

<div class="absolute bottom-5 left-5 text-2xl opacity-100">
...
<img src="/images/daily-focus-priority.png" class="absolute inset-0 w-full h-full object-cover" />
...
<img src="/images/eisenhower-c3po-v2.png" class="absolute inset-0 w-full h-full object-cover" />
...
<img src="/images/zero-task-flow.png" class="max-h-96 rounded-lg shadow-lg" />
...
<img src="/images/saying-no.png" class="absolute inset-0 w-full h-full object-cover" />
...
<img src="/images/s3-rule-v3.png" class="absolute inset-0 w-full h-full object-cover" />
...
<img src="/images/objective.png" class="absolute inset-0 w-full h-full object-cover" />
...
<img src="/images/summary.png" class="absolute inset-0 w-full h-full object-cover" />
...
<div class="absolute bottom-10 left-0 text-sm opacity-60 w-full text-center">
Sefi Ninio | monday.com
</div>
